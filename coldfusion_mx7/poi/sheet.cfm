...
<cfswitch expression="#THISTAG.ExecutionMode#">
	...
	<cfcase value="End">
			...
			<cfif StructKeyExists( VARIABLES.ColumnClasses[ VARIABLES.ColumnIndex ], "width" )>
				...
				<cfelseif Val( VARIABLES.ColumnWidth )>
					...
					<cfset VARIABLES.Sheet.SetColumnWidth(
						JavaCast( "int", (VARIABLES.ColumnIndex - 1) ),
						JavaCast( "int", Min( 32767, (Val( VARIABLES.ColumnWidth ) * 37) ) )
						) />
		...
		<cfset VARIABLES.DocumentTag.SheetIndex = (VARIABLES.DocumentTag.SheetIndex + 1) />	
