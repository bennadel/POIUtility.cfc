...
<cfswitch expression="#THISTAG.ExecutionMode#">
	...
	<cfcase value="End">
		...
		<cfif Len( THISTAG.GeneratedContent )>
			...
			<cfswitch expression="#ATTRIBUTES.Type#">
				...
				<cfcase value="formula">
					...
					<cfset VARIABLES.Aliases = VARIABLES.DocumentTag.CSSRule.REMatchArray( "@[\w_-]+", THISTAG.GeneratedContent ) />
				
					<!--- Loop over any aliases that we have. --->
					<cfloop
						index="VARIABLES.AliasIndex"
						from="1"
						to="#ArrayLen( VARIABLES.Aliases )#"
						step="1">
					
						<!--- Get the alias. --->
						<cfset VARIABLES.Alias = VARIABLES.Aliases[ VARIABLES.AliasIndex ] />
		...
		<cfset VARIABLES.RowTag.CellIndex = (VARIABLES.RowTag.CellIndex + ATTRIBUTES.ColSpan) />
